"""Moved to `erouter.chain.tricrypto_params` -- tricrypto parameter readers.
...
from ..chain import tricrypto_params as _moved
from ..chain.tricrypto_params import *  # noqa: F403
