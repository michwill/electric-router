"""Moved to `erouter.chain.lending_params` -- lending-wrapper rate readers.
...
from ..chain import lending_params as _moved
from ..chain.lending_params import *  # noqa: F403
